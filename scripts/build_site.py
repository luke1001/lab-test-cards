...
body { margin: 0; background: #f6f8fb; overflow-x: hidden; }
a { color: inherit; }
...
.study-notes { background: #fff; border: 1px solid #d8dee8; border-radius: 8px; padding: 24px; min-width: 0; }
.study-notes h2 { margin: 22px 0 8px; font-size: 1rem; }
.study-notes h2:first-child { margin-top: 0; }
.study-notes p, .study-notes li { color: #475569; line-height: 1.55; overflow-wrap: anywhere; }
...
@media (min-width: 1280px) {
  .index-page, .test-page { width: min(1240px, calc(100% - 48px)); }
  .test-grid { grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); }
}
@media (max-width: 760px) {
  .index-page, .test-page { width: min(100% - 24px, 1120px); padding-top: 18px; padding-bottom: 40px; }
  .index-hero, .test-hero { padding: 22px 0 20px; }
  .study-layout, .test-hero { grid-template-columns: 1fr; display: grid; gap: 18px; }
...
@media (max-width: 420px) {
  ...
  .study-card { max-width: 100%; box-shadow: 0 10px 28px rgba(15, 23, 42, 0.12); }
}
@media print {
  body { background: #fff; }
